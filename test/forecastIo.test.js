define(['angular-mocks', 'forecastIo'], function () {
    ...
    describe('forecastIo', function () {
        ...
        beforeEach(module('forecastIo', function (forecastIoProvider) {
            forecastIoProvider.config.apiKey = '82f9b0c2328032d8cb168d72ce202fbe';
        }));

        beforeEach(inject(function(_forecastIo_, _$httpBackend_) {
