define(['angular', 'angular-mocks', 'geocoder'], function (angular) {
  ...
  describe('geocoder', function () {
    ...
    beforeEach(angular.mock.module('geocoder', function (geocoderProvider) {
      geocoderProvider.config.google.serverApiKey = 'AIzaSyDmjRbBjb6x4YGyQm8CKG21Kocsix-D3kY';
    }));

    beforeEach(angular.mock.inject(function(_geocoder_, _$httpBackend_) {
      geocoder = _geocoder_;
